...
% Implementación del comando \diagram con letras ENCUADRADAS fuera del marco de la estrofa
\newcommand\diagram[2]{%
  \begin{verse}
    \hspace*{-2cm}\fbox{\textbf{#1}}\hspace{2.5cm}
    #2
  \end{verse}
}

% Comando esquema alternativo con letras encuadradas fuera del marco
\newcommand\esquema[2]{%
  \begin{verse}
    \hspace*{-2cm}\fbox{\textbf{#1}}\hspace{2.5cm}
    #2
