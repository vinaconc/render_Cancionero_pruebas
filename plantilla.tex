...
\renewcommand\diagram[2]{%
  \begin{tcolorbox}[enhanced,
                    frame hidden,                   % quitar bordes completos
                    borderline west={1pt}{0pt}{black}, % línea izquierda
                    left=3mm, right=0mm, top=1mm, bottom=1mm,
                    sharp corners,
                    width=\linewidth]               % ancho de la columna
    \textbf{#1} \hspace{0.5cm} #2
  \end{tcolorbox}%
}
