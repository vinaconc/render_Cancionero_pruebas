...
\beginsong{Gloria Tradicional}
\index[titleidx]{Gloria Tradicional}
\phantomsection
\label{cancion-Gloria-Tradicional}
\beginverse
\diagram{A}{\[La]Glo\[Re]ria a \[fa\#]Dios \[Re]en el \[Mi]Cielo, \\\[Re]y \[Mi]en la \[La]Tie\[fa\#]rra \[Re]Paz \[Sim]a los \[La]Hom\[fa\#]bres que \[Sim/Re]a\[Mi7]ma el Se\[La]ñor. \\}
\endverse
\beginverse
